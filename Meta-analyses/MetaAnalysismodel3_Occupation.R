...
#
# Script meta-analysis model 3: Run fixed- and random-effects meta-analysis of
# Cox Proportional-Hazards models with age of onset as timescale, with
# trait-specific PGS by occupation level, sex (except for breast and prostate
# cancer), birth decade, and the first 10 genetic PCS as covariates across
...
#
# required input data: FGR11 + UKB + GS model 3 (from INTERVENE GxE_SESDisease
# GoogleDrive Folder)
#
...
metaresults.3 <- c()
for(l in c("Lower-level","Upper-level")){
...
# write to file
fwrite(metaresults.3, paste("output/EmploymentStatus/MetaAnalysis/FGR11_UKB_GS/model3/", as.character(Sys.Date()), 
                            "_INTERVENE_Occupation_FEMetaAnalysis_FinnGenR11_UKB_GenScot_model3.csv",sep=""))
...
# write to file
fwrite(metaresultsr.3, paste("output/EmploymentStatus/MetaAnalysis/FGR11_UKB_GS/model3/", as.character(Sys.Date()), 
                            "_INTERVENE_Occupation_REMetaAnalysis_FinnGenR11_UKB_GenScot_model3.csv",sep=""))
...
# fixed effect
drive_upload(media = "output/EmploymentStatus/MetaAnalysis/FGR11_UKB_GS/model3/2026-03-13_INTERVENE_Occupation_FEMetaAnalysis_FinnGenR11_UKB_GenScot_model3.csv",
             path = as_id("1Wi0KDwGtnZoUclUgZwu7F_Dwj-6uvJYH"),
             name = "2026-03-13_INTERVENE_Occupation_FEMetaAnalysis_FinnGenR11_UKB_GenScot_model3.csv",
             type = "spreadsheet")

# random effect
drive_upload(media = "output/EmploymentStatus/MetaAnalysis/FGR11_UKB_GS/model3/2026-03-13_INTERVENE_Occupation_REMetaAnalysis_FinnGenR11_UKB_GenScot_model3.csv",
             path = as_id("1Wi0KDwGtnZoUclUgZwu7F_Dwj-6uvJYH"),
             name = "2026-03-13_INTERVENE_Occupation_REMetaAnalysis_FinnGenR11_UKB_GenScot_model3.csv",
             type = "spreadsheet")
