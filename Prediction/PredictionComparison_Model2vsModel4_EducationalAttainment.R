...
#
# Script: Compare prediction accuracy of model 2 (main effects of education and
# disease-specific PGS) with model 4 (main effects of education and
# disease-specific PGS + their interaction) by comparing the models Receiver
...
#   the output of the CoxPH models 2 and 4 based 80% of the 
...
#
# Last edits: 16/04/2026 (edits, FAH: ensure all biobanks now predict using the 
...
# read in model 4
FGR11.4 <- fread("[PathToCoxOutputModel4/CoxOutputModel4File]", data.table=FALSE)
