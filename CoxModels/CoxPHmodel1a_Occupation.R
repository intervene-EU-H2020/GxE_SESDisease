...
###############################################################################
#
# Run Cox Proportional-Hazards model 1a) Occupation (Manual worker as
# reference), sex (except for prostate and breast cancer), first 5 genetic PCs
# as covariates.
#
################################################################################
...
# run Cox-PH model 1 in loop with foreach  in parallel for each of the 19 diseases.
...
write.table(modcoeffs.cox.model1a, file=paste0("[PathToOutputFolder/]",as.character(Sys.Date()),
                                               "_",Biobank,"_INTERVENE_Occupation_CoxPH_model1a_Coeffs.txt"),
