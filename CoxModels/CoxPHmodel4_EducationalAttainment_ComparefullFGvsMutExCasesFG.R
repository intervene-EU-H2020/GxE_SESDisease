...
# CoxPH models in FG data after excluding mutual cases (e.g., individuals who
# are a case for >1 of the 19 complex diseases)
#
# Data: Results CoxPH full FG + subset FG with mutually exclusive cases
#
# Last edits: 20/04/2026 (edits, FAH: last updates before GitHub upload)
# 
################################################################################
...
fwrite(plot12_diff, paste("output/2classEA/FG11/CoxPropHaz_model4/", as.character(Sys.Date()),
                          "_INTERVENE_SESDiffDiseases_Differences_FullFinnGenR11vsNoMutcases_model4.csv",sep=""))
...
# model 1a
drive_upload(media = "output/2classEA/FG11/CoxPropHaz_model4/2026-03-24_INTERVENE_SESDiffDiseases_Differences_FullFinnGenR11vsNoMutcases_model4.csv",
             path = as_id("18iI9QxxJ7WXrXO6hcNal_amvGmR1F_jv"),
             name = "2026-03-24_INTERVENE_SESDiffDiseases_Differences_FullFinnGenR11vsNoMutcases_model4.csv",
             type = "spreadsheet")
