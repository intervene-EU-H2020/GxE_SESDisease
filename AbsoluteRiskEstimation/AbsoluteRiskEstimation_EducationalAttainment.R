...
for(j in 1:length(EDU)){
  ...
  for (z in 1:length(biobank_traits[[j]])) {  
    ...
    write.csv(lifetimerisk, paste0("output/LifetimeRisk/model6/",biobank,"/",as.character(Sys.Date()),"_",biobank_traits[[j]][z],"_LifetimeRisk_",education[j],"_",biobank,".csv"))
    ...
    ggsave(paste0("output/LifetimeRisk/model6/",biobank,"/",as.character(Sys.Date()),"_",biobank_traits[[j]][z],"_LifetimeRisk_",education[j],"_",biobank,".png"), height=6, width=8, dpi=300)
