...
# Last edits: 24/06/2025 (FAH, edits: last edits prior to upload GitHub)
# 
################################################################################
...
for(j in 1:length(OCC)){
  ...
  for (z in 1:length(biobank_traits[[j]])) {  
    ...
    lifetimeriskactual <- fread(paste0("output/LifetimeRisk/model6/",biobank,"/","2025-03-27_",biobank_traits[[j]][z],"_LifetimeRisk_",occupation[j],"_",biobank,".csv"), select=c("LifetimeRisk"), data.table=FALSE)
    ...
    write.csv(bootstrapped_lifetimerisk, paste0("output/LifetimeRisk/model6/",biobank,"/",as.character(Sys.Date()),"_",biobank_traits[[j]][z],"_LifetimeRisk_",occupation[j],"_Bootstrapped_",biobank,".csv"))
    ...
    ggsave(paste0("output/LifetimeRisk/model6/",biobank,"/",as.character(Sys.Date()),"_",biobank_traits[[j]][z],"_LifetimeRisk_",occupation[j],"_Bootstrapped_",biobank,".png"), height=10 , width=10)
