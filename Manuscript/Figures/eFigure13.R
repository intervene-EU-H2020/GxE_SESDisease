...
# occupation for Finngen (FGR11)))
#
# Data: Bootstrapped lifetime risk estimates for occupation stratified PGSs for
...
# bootstrapped lifetime risk estimates - Lower-level Occupation
ASTHMAlow <- fread("output/LifetimeRisk/model6/FinnGen/2025-03-27_J10_ASTHMA_LifetimeRisk_LowerlevelOccupation_Bootstrapped_FinnGen.csv",data.table=FALSE)
CHDlow <- fread("output/LifetimeRisk/model6/FinnGen/2025-03-27_I9_CHD_LifetimeRisk_LowerlevelOccupation_Bootstrapped_FinnGen.csv",data.table=FALSE)
Hiplow <- fread("output/LifetimeRisk/model6/FinnGen/2025-03-27_COX_ARTHROSIS_LifetimeRisk_LowerlevelOccupation_Bootstrapped_FinnGen.csv",data.table=FALSE)
Kneelow <- fread("output/LifetimeRisk/model6/FinnGen/2025-03-27_KNEE_ARTHROSIS_LifetimeRisk_LowerlevelOccupation_Bootstrapped_FinnGen.csv",data.table=FALSE)
Cancerlow <- fread("output/LifetimeRisk/model6/FinnGen/2025-03-27_C3_CANCER_LifetimeRisk_LowerlevelOccupation_Bootstrapped_FinnGen.csv",data.table=FALSE)
Prostatelow <- fread("output/LifetimeRisk/model6/FinnGen/2025-03-27_C3_PROSTATE_LifetimeRisk_LowerlevelOccupation_Bootstrapped_FinnGen.csv",data.table=FALSE)
AFlow <- fread("output/LifetimeRisk/model6/FinnGen/2025-03-27_I9_AF_LifetimeRisk_LowerlevelOccupation_Bootstrapped_FinnGen.csv",data.table=FALSE)
T2Dlow <- fread("output/LifetimeRisk/model6/FinnGen/2025-03-27_T2D_LifetimeRisk_LowerlevelOccupation_Bootstrapped_FinnGen.csv",data.table=FALSE)

# bootstrapped lifetime risk estimates - Upper-level Occupation
Cancerhigh <- fread("output/LifetimeRisk/model6/FinnGen/2025-03-27_C3_CANCER_LifetimeRisk_UpperlevelOccupation_Bootstrapped_FinnGen.csv",data.table=FALSE)
Asthmahigh <- fread("output/LifetimeRisk/model6/FinnGen/2025-03-27_J10_ASTHMA_LifetimeRisk_UpperlevelOccupation_Bootstrapped_FinnGen.csv",data.table=FALSE)
CHDhigh <- fread("output/LifetimeRisk/model6/FinnGen/2025-03-27_I9_CHD_LifetimeRisk_UpperlevelOccupation_Bootstrapped_FinnGen.csv",data.table=FALSE)
Hiphigh <- fread("output/LifetimeRisk/model6/FinnGen/2025-03-27_COX_ARTHROSIS_LifetimeRisk_UpperlevelOccupation_Bootstrapped_FinnGen.csv",data.table=FALSE)
Kneehigh <- fread("output/LifetimeRisk/model6/FinnGen/2025-03-27_KNEE_ARTHROSIS_LifetimeRisk_UpperlevelOccupation_Bootstrapped_FinnGen.csv",data.table=FALSE)
Prostatehigh <- fread("output/LifetimeRisk/model6/FinnGen/2025-03-27_C3_PROSTATE_LifetimeRisk_UpperlevelOccupation_Bootstrapped_FinnGen.csv",data.table=FALSE)
AFhigh <- fread("output/LifetimeRisk/model6/FinnGen/2025-03-27_I9_AF_LifetimeRisk_UpperlevelOccupation_Bootstrapped_FinnGen.csv",data.table=FALSE)
T2Dhigh <- fread("output/LifetimeRisk/model6/FinnGen/2025-03-27_T2D_LifetimeRisk_UpperlevelOccupation_Bootstrapped_FinnGen.csv",data.table=FALSE)
...
# add variable to indicate whether results are for low vs Upper-level Occupation
...
ASTHMA$Education <- factor(ASTHMA$Education, levels = c("low","high"),
                       labels = c("Lower-level Occupation","Upper-level Occupation"))
...
################################################################################
#
# Create lifetime risk plots where low vs Upper-level Occupation are panels  
#
################################################################################
...
# T2D
Fig.T2D <- ggplot(T2D, aes(age, LifetimeRisk, color=Group, group=Group)) +
  # Theme
  labs(x="Age Range", y="Cummulative Risk (%)", title="", fill=NULL, subtitle="") +
  theme_hrs(base_size=base_size, plot_top_margin=-20,legend_pos = "none") +
  ## Fonts
...
# AF
Fig.AF <- ggplot(AF, aes(age, LifetimeRisk, color=Group, group=Group)) +
  # Theme
  labs(x="Age Range", y="Cummulative Risk (%)", title="", fill=NULL, subtitle="") +
  theme_hrs(base_size=base_size, plot_top_margin=-20,legend_pos = "none") +
  ## Fonts
...
top_plt <- plot_grid(Fig.Asthma,Fig.Cancer,
                     ...
                     Fig.T2D,Fig.AF,nrow=4)
# add additional empty space for legends
Fig13 <- plot_grid(top_plt,NULL, nrow=2, rel_heights=c(0.95, 0.05))

# save figure as png
png(filename = paste0("output/Figures/Manuscript/",as.character(Sys.Date()),
                      "_INTERVENE_Occupation_eFigure13.png"),
