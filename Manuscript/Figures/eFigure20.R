...
#
# Last edits: 16/04/2026 (edits, FAH: in the old version this was efigure9 now
# it is efigure20)
# 
################################################################################
...
Fig20 <- plot_grid(NULL,top_plt, nrow=2, rel_heights=c(0.05,0.95))

# save figure as png
png(filename = paste0("output/Figures/Manuscript/",as.character(Sys.Date()),
                       "_INTERVENE_EducationalAttainment_eFigure20.png"),
